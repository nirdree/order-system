        ...
        <div className="bg-white rounded-xl p-3 shadow-md border border-amber-100">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mb-3">
            ...
            <div className="relative">
              ...
              <select value={filterRole} onChange={(e) => setFilterRole(e.target.value)} className="w-full pl-9 pr-8 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-amber-500 appearance-none">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="bg-green-50 rounded-lg p-2 border border-green-200 text-center">
              ...
              <p className="text-base font-bold text-green-700">{users.filter(u => u.isActive).length}</p>
            </div>
            <div className="bg-purple-50 rounded-lg p-2 border border-purple-200 text-center">
              <p className="text-xs text-gray-600 mb-0.5">Managers</p>
              <p className="text-base font-bold text-purple-700">{users.filter(u => u.role === 'manager').length}</p>
            </div>
            <div className="bg-blue-50 rounded-lg p-2 border border-blue-200 text-center">
              <p className="text-xs text-gray-600 mb-0.5">Staff</p>
              <p className="text-base font-bold text-blue-700">{users.filter(u => u.role === 'staff').length}</p>
            </div>
          </div>
        </div>
      </div>
